                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-success">Nilai V</h6>
                                </div>
                                <div class="card-body">
                                    <div class="my-2"></div>
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            include "config.php";
                                            $a = "SELECT `wp_nilais`.`id_daerah` AS `id_daerah`,`wp_nilais`.`nm_daerah` AS `nm_daerah`,(`wp_nilais`.`nilaiS` / `wp_sums`.`jum`) AS `nilaiV`
FROM (`wp_nilais`
JOIN `wp_sums`)";
                                            $b = $con->query($a);
                                            while ($c = $b->fetch_row()) {
