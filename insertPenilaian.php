                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-success">Tambah Bobot</h6>
                                </div>
                                <div class="card-body">
                                    <form action="proses/prosesPenilaian.php" method="POST">
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" name="id_daerah">
                                                    ...
                                                    while ($c = $b->fetch_array()) {
                                                    ?>
                                                        <option value=<?php echo $c['id_daerah'] ?>>
                                                            <?php echo $c['nm_daerah'] ?>
                                                        </option>
                                                    <?php
                                                    }
                                                    ?>
