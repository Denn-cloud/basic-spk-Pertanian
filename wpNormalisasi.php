                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-success">Normalisasi</h6>
                                </div>
                                <div class="card-body">
                                    <div class="my-2"></div>
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            include "config.php";
                                            $a = "SELECT tabel_bobot.*,wp_jumbobot.jumlah,(tabel_bobot.valuebobot/wp_jumbobot.jumlah) AS normalisasi_w FROM tabel_bobot, wp_jumbobot";
                                            $b = $con->query($a);
                                            while ($c = $b->fetch_row()) {
                                            ?>
                                                <tr>
